        ...
        <div className="max-w-5xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="px-4">
            ...
            <p className="mt-4 text-lg text-slate-600 max-w-xl">
              Sign in to your PayQuick account — quick overview and direct
              access to your transactions and profile.
            </p>
          </div>

          <form
            onSubmit={handleSubmit(onSubmit)}
            className="w-full max-w-md mx-auto bg-white shadow-lg rounded-2xl p-8 sm:p-10 ring-1 ring-slate-100"
          >
            ...
            <p className="mt-6 text-xs text-black-400">
              Use <b>username</b>: <i className="text-indigo-600">jane</i> and{" "}
              <b>password</b>: <i className="text-indigo-600">password123</i>{" "}
              for this demo.
            </p>
          </form>
        </div>
